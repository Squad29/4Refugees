...
namespace ForRefugees.Controllers
{
    public class RefugiadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Cidade,Telefone,Estado,Profissao,Nacionalidade,Bio,DataNascimento,DataCadastro,ValorHora,Endereco,Bairro")] Refugiado refugiado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Cidade,Telefone,Estado,Profissao,Nacionalidade,Bio,DataNascimento,DataCadastro,ValorHora,Endereco,Bairro")] Refugiado refugiado)
        {
            if (id != refugiado.Id)
            {
                return NotFound();
